...
\begin{figure}
    ...
    \caption{‌Bayesian Network structure learned using Hill Climbing with AIC score, used as a representative model for probabilistic inference and classification.}
    \label{fig:network}
\end{figure}
% }
